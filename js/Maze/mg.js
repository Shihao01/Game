...
MG.prototype = {
	...
	_showByCanvas: function () {
		...
		finish_img.src = "assert/Maze/finish.gif";
...
function MG_Me(mg) {
	...
	this.finished = false;
	this.emotions = {
		normal: "assert/Maze/me.gif",
		happy: "assert/Maze/me_happy.gif",
		unhappy: "assert/Maze/me_unhappy.gif",
		surprised: "assert/Maze/me_surprised.gif",
		tongue: "assert/Maze/me_tongue.gif"
	};
...
MG_Me.prototype = {
	init: function () {
		...
		tmp_img.setAttribute("src", "assert/Maze/me.gif");
		this.me_img = tmp_img;
